...
contract RandomNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, VRFConsumerBaseV2 {
    ...
    uint32 numWords = 2;    //  请求多少随机数
    //      request    tokenId
    mapping(uint256 => uint256) requestIdToTokenId;

    // 12902 0x2Ca8E0C643bDe4C2E08ab1fA0da3401AdAD7734D
    constructor(
    ...
    function fulfillRandomWords(
        ...
        _setTokenURI(tokenId, _setURI(random));
